...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  if (isset($_POST['Soundness'])) {
    include('../database/soundness/save.php');
  }
}
?>
            ...
            <div class="card-body">
              ...
              <table class="table table-bordered">
                <tbody>
                  <tr>
                    <th>Wt Dry Soil, g</th>
                    <td><input type="text" style="border: none" class="form-control" name="WtDrySoil" id="WtDrySoil" /></td>
                  </tr>
                  <tr>
                    <th>Wt Washed, g</th>
                ...
                <tbody>
                  ...
                  foreach ($sizes as $size => $mm): ?>
                    <tr>
                      ...
                      <td>
                        <input type="text" style="border: none" class="form-control" name="WtRetCoarse<?php echo $i; ?>" id="WtRetCoarse<?php echo $i; ?>" />
                      </td>
                      <td>
                        <input type="text" style="border: none" class="form-control" name="PctRetCoarse<?php echo $i; ?>" id="PctRetCoarse<?php echo $i; ?>" readonly tabindex="-1" />
                      </td>
                    </tr>
                  <?php $i++;
                  endforeach; ?>
                  <tr>
                    ...
                    <td>
                      <input type="text" style="border: none" class="form-control" name="WtRetCoarseTotal" id="WtRetCoarseTotal" readonly tabindex="-1" />
                    </td>
                    <td>
                      <input type="text" style="border: none" class="form-control" name="PctRetCoarseTotal" id="PctRetCoarseTotal" readonly tabindex="-1" />
                    </td>
                  </tr>
                </tbody>
              </table>
                ...
                <tbody>
                  ...
                  foreach ($sizes as $size => $mm): ?>
                    <tr>
                      ...
                      <th><?php echo htmlspecialchars($mm); ?></th>
                      <td>
                        <input type="text" style="border: none" class="form-control" name="WtRetFine<?php echo $i; ?>" id="WtRetFine<?php echo $i; ?>" />
                      </td>
                      <td>
                        <input type="text" style="border: none" class="form-control" name="PctRetFine<?php echo $i; ?>" id="PctRetFine<?php echo $i; ?>" readonly tabindex="-1" />
                      </td>
                    </tr>
                  <?php $i++;
                  endforeach; ?>
                  <tr>
                    <th scope="row" colspan="2">Total</th>
                    <td>
                      <input type="text" style="border: none" class="form-control" name="WtRetFineTotal" id="WtRetFineTotal" readonly tabindex="-1" />
                    </td>
                    <td>
                      <input type="text" style="border: none" class="form-control" name="PctRetFineTotal" id="PctRetFineTotal" readonly tabindex="-1" />
                    </td>
                  </tr>
                </tbody>
              </table>
                ...
                <tbody>
                  <?php foreach ($cycles as $cycle): ?>
                    <tr>
                      ...
                      <td>
                        <input type="date" style="border: none" class="form-control" name="StartDate<?php echo $cycle; ?>" id="StartDate<?php echo $cycle; ?>" tabindex="-1" />
                      </td>
                      <td>
                        <input type="text" style="border: none" class="form-control" name="RoomTemp<?php echo $cycle; ?>" id="RoomTemp<?php echo $cycle; ?>" />
                      </td>
                      <td>
                        <input type="text" style="border: none" class="form-control" name="SolutionTemp<?php echo $cycle; ?>" id="SolutionTemp<?php echo $cycle; ?>" />
                      </td>
                      <td>
                        <input type="text" style="border: none" class="form-control" name="SpecificGravity<?php echo $cycle; ?>" id="SpecificGravity<?php echo $cycle; ?>" />
                      </td>
                    </tr>
                  <?php endforeach; ?>
                  <tr>
              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  foreach ($sieveSizes as $index => $size) {
                    ...
                    echo '<td><input type="text" style="border: none" class="form-control" name="SplittingNo' . ($index + 1) . '" id="SplittingNo' . ($index + 1) . '" /></td>';
                    echo '<td><input type="text" style="border: none" class="form-control" name="SplittingPct' . ($index + 1) . '" id="SplittingPct' . ($index + 1) . '" readonly tabindex="-1" /></td>';
                    echo '<td><input type="text" style="border: none" class="form-control" name="CrumblingNo' . ($index + 1) . '" id="CrumblingNo' . ($index + 1) . '" /></td>';
                    echo '<td><input type="text" style="border: none" class="form-control" name="CrumblingPct' . ($index + 1) . '" id="CrumblingPct' . ($index + 1) . '" readonly tabindex="-1" /></td>';
                    echo '<td><input type="text" style="border: none" class="form-control" name="CrackingNo' . ($index + 1) . '" id="CrackingNo' . ($index + 1) . '" /></td>';
                    echo '<td><input type="text" style="border: none" class="form-control" name="CrackingPct' . ($index + 1) . '" id="CrackingPct' . ($index + 1) . '" readonly tabindex="-1" /></td>';
                    echo '<td><input type="text" style="border: none" class="form-control" name="FlakingNo' . ($index + 1) . '" id="FlakingNo' . ($index + 1) . '" /></td>';
                    echo '<td><input type="text" style="border: none" class="form-control" name="FlakingPct' . ($index + 1) . '" id="FlakingPct' . ($index + 1) . '" readonly tabindex="-1" /></td>';
                    echo '<td><input type="text" style="border: none" class="form-control" name="TotalParticles' . ($index + 1) . '" id="TotalParticles' . ($index + 1) . '" /></td>';
                    echo '</tr>';
                  }
                  ?>
                </tbody>
              ...
              <table class="table table-bordered">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><input type="text" style="border: none" class="form-control" name="TotalStarWeightRet" id="TotalStarWeightRet" readonly tabindex="-1" /></td>
                    <td>---</td>
                    <td>---</td>
                    <td><input type="text" style="border: none" class="form-control" name="TotalFinalWeightRet" id="TotalFinalWeightRet" readonly tabindex="-1" /></td>
                    <td></td>
                    <td><input type="text" style="border: none" class="form-control" name="TotalWeightedLoss" id="TotalWeightedLoss" readonly tabindex="-1" /></td>
                  </tr>
                </tbody>
              </table>
              ...
              <table class="table table-bordered">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><input type="text" style="border: none" class="form-control" name="WeightedLossCoarse1" id="WeightedLossCoarse1" readonly tabindex="-1" /></td>
                  </tr>
                  <tr>
                    ...
                    <td rowspan="2"><input type="text" style="border: none" class="form-control" name="WeightedLossCoarse2" id="WeightedLossCoarse2" readonly tabindex="-1" /></td>
                  </tr>
                  <tr>
                    <td>19.0mm(3⁄4 in) to 12.5 mm (1⁄2 in)</td>
                    <td>(670+-10)g</td>
                    <td><input type="text" style="border: none" class="form-control" name="StarWeightRetCoarse3" id="StarWeightRetCoarse3" /></td>
                  </tr>
                  <tr>
                    ...
                    <td rowspan="2"><input type="text" style="border: none" class="form-control" name="WeightedLossCoarse3" id="WeightedLossCoarse3" readonly tabindex="-1" /></td>
                  </tr>
                  <tr>
                    <td>37.5mm(11⁄2 in) to 25.0 mm (1 in.)</td>
                    <td>(1000+-50)g</td>
                    <td><input type="text" style="border: none" class="form-control" name="StarWeightRetCoarse5" id="StarWeightRetCoarse5" /></td>
                  </tr>
                  <tr>
                    ...
                    <td rowspan="2"><input type="text" style="border: none" class="form-control" name="WeightedLossCoarse4" id="WeightedLossCoarse4" readonly tabindex="-1" /></td>
                  </tr>
                  <tr>
                    <td>63 mm (2 1⁄2 in) to 50 mm (2 in)</td>
                    <td>(3000+-300)g</td>
                    <td><input type="text" style="border: none" class="form-control" name="StarWeightRetCoarse7" id="StarWeightRetCoarse7" /></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td></td>
                    <td><input type="text" style="border: none" class="form-control" name="TotalWeightedLossCoarse" id="TotalWeightedLossCoarse" readonly tabindex="-1" /></td>
                  </tr>
                </tbody>
              </table>
