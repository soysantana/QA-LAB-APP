    ...
    <section class="section">
        <div class="row">
            ...
            <div class="col-lg-6">
                ...
                <?php $week = date('Y-m-d', strtotime('-6 days')); ?>
                <?php $RevNotify = find_by_sql("SELECT * FROM test_reviewed WHERE Start_Date >= DATE_SUB(NOW(), INTERVAL 6 DAY) ORDER BY Start_Date DESC"); ?>
                <div class="card">
                    <div class="card-body">
            ...
            <div class="col-lg-6">
                ...
                <?php $RepNotify = find_by_sql("SELECT * FROM test_repeat WHERE Start_Date >= DATE_SUB(NOW(), INTERVAL 6 DAY) ORDER BY Start_Date DESC"); ?>
                <div class="card">
                    <div class="card-body">
                                                        ...
                                                        for ($i = 1; $i <= 19; $i++) {
                                                            ...
                                                            if (isset($req[$testTypeKey]) && $req[$testTypeKey] !== '') {
                                                                ...
                                                                foreach ($Reviewed as $review) {
                                                                    if (
                                                                        $review['Sample_ID'] == $req['Sample_ID'] &&
