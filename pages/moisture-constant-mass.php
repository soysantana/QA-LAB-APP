...
<section class="section">
  ...
  <form class="row" action="moisture-constant-mass.php" method="post">
              ...
              <table class="table table-bordered" oninput="MoistureConstantMass()">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><input type="text" style="border: none;" class="form-control" name="OvenTemp" id="OvenTemp" value="60 °C"></td>
                  </tr>
                  <tr>
    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="d-grid gap-2 mt-3">
          <button type="submit" class="btn btn-success" name="moisture-constant-mass">Save Essay</button>
        </div>
