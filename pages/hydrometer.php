                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-bordered table-sm">
                                <tbody>
                                    ...
                                    <tr>
                                        <th scope="row">1</th>
                                        <td><input type="date" style="border: none;" class="form-control" name="Date1" id="Date1" readonly tabindex="-1"></td>
                                        <td><input type="time" style="border: none;" class="form-control" name="Hour1" id="Hour1" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="ReadingTimeT1" id="ReadingTimeT1" value="1" readonly tabindex="-1"></td>
                                        ...
                                        <td><input type="text" style="border: none;" class="form-control" name="ABdependingHy1" id="ABdependingHy1" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="OffsetReading1" id="OffsetReading1" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="MassPercentFiner1" id="MassPercentFiner1" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="EffectiveLength1" id="EffectiveLength1" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="DMm1" id="DMm1" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="PassingPerceTotalSample1" id="PassingPerceTotalSample1" readonly tabindex="-1"></td>
                                    </tr>
                                    <tr>
                                        <th scope="row">2</th>
                                        <td><input type="date" style="border: none;" class="form-control" name="Date2" id="Date2" readonly tabindex="-1"></td>
                                        <td><input type="time" style="border: none;" class="form-control" name="Hour2" id="Hour2" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="ReadingTimeT2" id="ReadingTimeT2" value="2" readonly tabindex="-1"></td>
                                        ...
                                        <td><input type="text" style="border: none;" class="form-control" name="ABdependingHy2" id="ABdependingHy2" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="OffsetReading2" id="OffsetReading2" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="MassPercentFiner2" id="MassPercentFiner2" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="EffectiveLength2" id="EffectiveLength2" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="DMm2" id="DMm2" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="PassingPerceTotalSample2" id="PassingPerceTotalSample2" readonly tabindex="-1"></td>
                                    </tr>
                                    <tr>
                                        <th scope="row">3</th>
                                        <td><input type="date" style="border: none;" class="form-control" name="Date3" id="Date3" readonly tabindex="-1"></td>
                                        <td><input type="time" style="border: none;" class="form-control" name="Hour3" id="Hour3" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="ReadingTimeT3" id="ReadingTimeT3" value="4" readonly tabindex="-1"></td>
                                        ...
                                        <td><input type="text" style="border: none;" class="form-control" name="ABdependingHy3" id="ABdependingHy3" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="OffsetReading3" id="OffsetReading3" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="MassPercentFiner3" id="MassPercentFiner3" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="EffectiveLength3" id="EffectiveLength3" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="DMm3" id="DMm3" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="PassingPerceTotalSample3" id="PassingPerceTotalSample3" readonly tabindex="-1"></td>
                                    </tr>
                                    <tr>
                                        <th scope="row">4</th>
                                        <td><input type="date" style="border: none;" class="form-control" name="Date4" id="Date4" readonly tabindex="-1"></td>
                                        <td><input type="time" style="border: none;" class="form-control" name="Hour4" id="Hour4" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="ReadingTimeT4" id="ReadingTimeT4" value="15" readonly tabindex="-1"></td>
                                        ...
                                        <td><input type="text" style="border: none;" class="form-control" name="ABdependingHy4" id="ABdependingHy4" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="OffsetReading4" id="OffsetReading4" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="MassPercentFiner4" id="MassPercentFiner4" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="EffectiveLength4" id="EffectiveLength4" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="DMm4" id="DMm4" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="PassingPerceTotalSample4" id="PassingPerceTotalSample4" readonly tabindex="-1"></td>
                                    </tr>
                                    <tr>
                                        <th scope="row">5</th>
                                        <td><input type="date" style="border: none;" class="form-control" name="Date5" id="Date5" readonly tabindex="-1"></td>
                                        <td><input type="time" style="border: none;" class="form-control" name="Hour5" id="Hour5" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="ReadingTimeT5" id="ReadingTimeT5" value="30" readonly tabindex="-1"></td>
                                        ...
                                        <td><input type="text" style="border: none;" class="form-control" name="ABdependingHy5" id="ABdependingHy5" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="OffsetReading5" id="OffsetReading5" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="MassPercentFiner5" id="MassPercentFiner5" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="EffectiveLength5" id="EffectiveLength5" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="DMm5" id="DMm5" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="PassingPerceTotalSample5" id="PassingPerceTotalSample5" readonly tabindex="-1"></td>
                                    </tr>
                                    <tr>
                                        <th scope="row">6</th>
                                        <td><input type="date" style="border: none;" class="form-control" name="Date6" id="Date6" readonly tabindex="-1"></td>
                                        <td><input type="time" style="border: none;" class="form-control" name="Hour6" id="Hour6" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="ReadingTimeT6" id="ReadingTimeT6" value="60" readonly tabindex="-1"></td>
                                        ...
                                        <td><input type="text" style="border: none;" class="form-control" name="ABdependingHy6" id="ABdependingHy6" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="OffsetReading6" id="OffsetReading6" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="MassPercentFiner6" id="MassPercentFiner6" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="EffectiveLength6" id="EffectiveLength6" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="DMm6" id="DMm6" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="PassingPerceTotalSample6" id="PassingPerceTotalSample6" readonly tabindex="-1"></td>
                                    </tr>
                                    <tr>
                                        <th scope="row">7</th>
                                        <td><input type="date" style="border: none;" class="form-control" name="Date7" id="Date7" readonly tabindex="-1"></td>
                                        <td><input type="time" style="border: none;" class="form-control" name="Hour7" id="Hour7" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="ReadingTimeT7" id="ReadingTimeT7" value="240" readonly tabindex="-1"></td>
                                        ...
                                        <td><input type="text" style="border: none;" class="form-control" name="ABdependingHy7" id="ABdependingHy7" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="OffsetReading7" id="OffsetReading7" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="MassPercentFiner7" id="MassPercentFiner7" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="EffectiveLength7" id="EffectiveLength7" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="DMm7" id="DMm7" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="PassingPerceTotalSample7" id="PassingPerceTotalSample7" readonly tabindex="-1"></td>
                                    </tr>
                                    <tr>
                                        <th scope="row">8</th>
                                        <td><input type="date" style="border: none;" class="form-control" name="Date8" id="Date8" readonly tabindex="-1"></td>
                                        <td><input type="time" style="border: none;" class="form-control" name="Hour8" id="Hour8" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="ReadingTimeT8" id="ReadingTimeT8" value="360" readonly tabindex="-1"></td>
                                        ...
                                        <td><input type="text" style="border: none;" class="form-control" name="ABdependingHy8" id="ABdependingHy8" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="OffsetReading8" id="OffsetReading8" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="MassPercentFiner8" id="MassPercentFiner8" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="EffectiveLength8" id="EffectiveLength8" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="DMm8" id="DMm8" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="PassingPerceTotalSample8" id="PassingPerceTotalSample8" readonly tabindex="-1"></td>
                                    </tr>
                                    <tr>
                                        <th scope="row">9</th>
                                        <td><input type="date" style="border: none;" class="form-control" name="Date9" id="Date9" readonly tabindex="-1"></td>
                                        <td><input type="time" style="border: none;" class="form-control" name="Hour9" id="Hour9" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="ReadingTimeT9" id="ReadingTimeT9" value="1440" readonly tabindex="-1"></td>
                                        ...
                                        <td><input type="text" style="border: none;" class="form-control" name="ABdependingHy9" id="ABdependingHy9" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="OffsetReading9" id="OffsetReading9" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="MassPercentFiner9" id="MassPercentFiner9" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="EffectiveLength9" id="EffectiveLength9" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="DMm9" id="DMm9" readonly tabindex="-1"></td>
                                        <td><input type="text" style="border: none;" class="form-control" name="PassingPerceTotalSample9" id="PassingPerceTotalSample9" readonly tabindex="-1"></td>
                                    </tr>
                                </tbody>
                            </table>
