...
<main id="main" class="main">
  ...
  <section class="section">
    <div class="row">
      ...
      $Requisitions = find_by_sql("SELECT Sample_ID, Sample_Number, Sample_Date, Client, Test_Type FROM lab_test_requisition_form");
      ...
      <style>
        ...
        .table-hover.table-sm.table-bordered.datatable td {
          max-width: 300px;
          /* Cambia el ancho máximo según necesites */
          white-space: nowrap;
          /* Evita el salto de línea dentro de las celdas */
          overflow: hidden;
                  ...
                  <?php foreach ($Requisitions as $Requisition): ?>
                    ...
                    for ($i = 1; $i <= 20; $i++) {
                      ...
                      if (!empty($Requisition[$column_name])) {
                        $count_solicitados++;
                        if (
                          !empty($test_delivery_data[$Requisition['Sample_ID']][$Requisition['Sample_Number']]) &&
