...
<main id="main" class="main">
  ...
  <section class="section">
    <div class="row" onchange="reactivityTest('FM13-007')">
      ...
      <form class="row" action="reactivity-coarse.php" method="post">
              ...
              <div class="row g-3">
                <div class="col-md-4">
                  ...
                  <select id="Standard" class="form-select" name="Standard">
                    ...
                    <option value="FM13-007">FM13-007</option>
                  </select>
                </div>
                <div class="col-md-4">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="d-grid gap-2 mt-3">
                <button type="submit" class="btn btn-success" name="SaveReactivity" value="FM13-007">Save Essay</button>
              </div>
