...
function UTF() {
  ...
  for (let i = 1; i <= 13; i++) {
    ...
    // Summary Grain Size Distribution Parameter
    PassArray.push(Pass);
    const CoarserGravel =  100 - PassArray[2];
    const Gravel =  PassArray[2] - PassArray[10];
    const Sand =  PassArray[10] - PassArray[12];
    const Fines =  PassArray[PassArray.length - 1];  
    ...
    document.getElementById("CoarserGravel").value = CoarserGravel.toFixed(2);
    document.getElementById("Gravel").value = Gravel.toFixed(2);
    document.getElementById("Sand").value = Sand.toFixed(2) + ' => 35';
    document.getElementById("Fines").value = Fines.toFixed(2) + ' 0-5';
  }
