/**
 * * Graph Grain Size Coarse Aggregate
 * */

echarts.init(document.querySelector("#GrainSizeCoarseAggregate")).setOption({
  xAxis: {
  ...
  series: [
    {
      data: [
        ...
        [1.18, document.getElementById("Pass13").value],
        [0.85, document.getElementById("Pass14").value],
        [0.30, document.getElementById("Pass15").value],
        [0.25, document.getElementById("Pass16").value],
