...
<main id="main" class="main">
  ...
  <section class="section">
    <div class="row" onchange="reactivityTest('FM13-007')">

      <form class="row" action="reactivity-coarse.php?id=<?php echo $Search['id']; ?>" method="post">
              ...
              <div class="row g-3">
                <div class="col-md-4">
                  ...
                  <select id="Standard" class="form-select" name="Standard">
                    ...
                    <option <?php if ($Search['Standard'] == 'FM13-007') echo 'selected'; ?>>FM13-007</option>
                  </select>
                </div>
                <div class="col-md-4">
              ...
              <table class="table table-bordered">
                <tbody>
                  <tr>
                    ...
                    <td><input type="text" style="border: none;" class="form-control" name="TotalWeight" id="TotalWeight" value="<?php echo ($Search['TotalWeight']); ?>"></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <th class="table-secondary" scope="row">Weight Mat. Ret. No. 4 (If Applicable)</th>
                    <td><input type="text" style="border: none;" class="form-control" name="WeightNo4" id="WeightNo4" value="<?php echo ($Search['WeightNo4']); ?>"></td>
                  </tr>
                  <tr>
                    <th class="table-secondary" scope="row">Wt Reactive Part. Ret. No.4 (If Applicable)</th>
                    <td><input type="text" style="border: none;" class="form-control" name="WeightReactiveNo4" id="WeightReactiveNo4" value="<?php echo ($Search['WeightReactiveNo4']); ?>"></td>
                  </tr>
                  <tr>
                    <th class="table-secondary" scope="row">Percent Reactive Particles (If Applicable)</th>
                    <td><input type="text" style="border: none;" class="form-control" name="PercentReactive" id="PercentReactive" value="<?php echo ($Search['PercentReactive']); ?>" readonly tabindex="-1"></td>
                  </tr>
                  <tr>
                    <th scope="row">Average Particles Reactive:</th>
                    <td><input type="text" style="border: none;" class="form-control" name="AvgParticles" id="AvgParticles" value="<?php echo ($Search['AvgParticles']); ?>" readonly tabindex="-1"></td>
                  </tr>
                  <tr>
                    <th scope="row">Reaction Strength Result:</th>
                    <td><input type="text" style="border: none;" class="form-control" name="ReactionResult" id="ReactionResult" value="<?php echo ($Search['ReactionResult']); ?>" readonly tabindex="-1"></td>
                  </tr>
                </tbody>
              </table>
              <!-- End Bordered Table -->
              ...
              <table class="table table-bordered">
                <tbody>
                  <tr>
                    ...
                    <td><input type="text" style="border: none;" class="form-control" name="AcidResult" id="AcidResult" value="<?php echo ($Search['AcidReactivityResult']); ?>" readonly tabindex="-1"></td>
                  </tr>
                </tbody>
              </table>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="d-grid gap-2 mt-3">
                <button type="submit" class="btn btn-success" name="UpdateReactivity" value="FM13-007">Update</button>
                ...
                <div class="btn-group dropup" role="group">
                  ...
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="../pdf/AR-CF.php?id=<?php echo ($Search['id']); ?>">PDF</a></li>
                  </ul>
                </div>
