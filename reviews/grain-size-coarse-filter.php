              ...
              <div class="d-grid gap-2 mt-3">
                ...
                <div class="btn-group dropup" role="group">
                  ...
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="../pdf/GS-CF-Build.php?id=<?php echo ($Search['id']); ?>">Contruccion</a></li>
                    <li><a class="dropdown-item" href="../pdf/GS-CF-Naranjo.php?id=<?php echo ($Search['id']); ?>">Naranjo</a></li>
                    <li><a class="dropdown-item" href="../pdf/GS-CF-Acopio.php?id=<?php echo ($Search['id']); ?>">Acopio</a></li>
                  </ul>
                </div>
...
<script src="../js/grain-size/gs-cf.js?v=0.0.2"></script>
