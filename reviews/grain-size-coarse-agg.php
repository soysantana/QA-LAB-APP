...
<div class="pagetitle">
  <h1>Grain Size Coarse Aggregate</h1>
  <nav>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="home.php">Home</a></li>
      <li class="breadcrumb-item">Forms</li>
      <li class="breadcrumb-item active">Grain Size Coarse Aggregate</li>
    </ol>
  </nav>
</div><!-- End Page Title -->
<section class="section">
  ...
  <form class="row" action="grain-size-coarse-agg.php?id=<?php echo $Search['id']; ?>" method="post">
  ...
  <div id="product_info">
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    $datos = array(
                      ...
                      array("No. 16", "1.18", "WtRet13", "Ret13", "CumRet13", "Pass13", "Specs13"),
                      array("No. 20", "0.85", "WtRet14", "Ret14", "CumRet14", "Pass14", "Specs14"),
                      array("No. 50", "0.3", "WtRet15", "Ret15", "CumRet15", "Pass15", "Specs15"),
                      array("No. 60", "0.25", "WtRet16", "Ret16", "CumRet16", "Pass16", "Specs16"),
                      array("No. 200", "0.075", "WtRet17", "Ret17", "CumRet17", "Pass17", "Specs17"),
    ...
    <div class="card">
      <div class="card-body">
        ...
        <div id="GrainSizeCoarseAggregate" style="min-height: 400px;" class="echart"></div>
...
<script src="../libs/graph/Grain-Size-Coarse.js"></script>
