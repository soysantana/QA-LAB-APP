...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  if (isset($_POST['update-sg-fine'])) {
    include('../database/specific-gravity/sg-ff/update.php');
  } elseif (isset($_POST['repeat-sg-fine'])) {
    include('../database/specific-gravity/sg-ff/repeat.php');
  } elseif (isset($_POST['reviewed-sg-fine'])) {
    include('../database/specific-gravity/sg-ff/reviewed.php');
  } elseif (isset($_POST['delete_sg_fine'])) {
    include('../database/specific-gravity/sg-ff/delete.php');
  }
}
?>
