  ...
  if (isset($_POST['p_name']) && strlen($_POST['p_name'])) {
    ...
    if ($results) {
      foreach ($results as $result) {
        ...
        $html .= '<label for="FieldComment" class="form-label">Field Comment</label>';
        $html .= '<input type="text" class="form-control" name="FieldComment" id="FieldComment" value="' . $result['Comment'] . '">';
        $html .= '</div>';
