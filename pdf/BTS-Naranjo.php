...
$pdf->AddPage('P', array(330, 390));

$pdf->setSourceFile('template/PV-F-80982 Laboratory Splitting Tensile Strength of Instact Rock Core Specime- Brazilian_Rev 4.pdf');
...
// Comments
$pdf->SetXY(22, 293);
$pdf->MultiCell(278, 4, $Search['Comments'], 0, 'L');
