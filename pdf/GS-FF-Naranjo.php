...
$pdf->SetXY(250, 361);
$pdf->Cell(154, 6, $Search['ClassificationUSCS1'], 0, 1, 'C');
$pdf->SetXY(250, 368);
$pdf->Cell(154, 6, $Search['ClassificationUSCS2'], 0, 1, 'C');
...
insertarImagenBase64($pdf, $GrainSizeChart, 20, 278, 220, 0); // ajusta X, Y, ancho, alto
