...
$pdf->SetXY(103, 144);
$pdf->Cell(39, 11, utf8_decode($Search['Pycnometer_Number']), 0, 1, 'C');
$pdf->SetXY(103, 155);
...
$pdf->SetXY(143, 260);
$pdf->MultiCell(114, 4, $Search['FieldComment'], 0, 'L');

$pdf->Output($Search['Sample_ID'] . '-' . $Search['Sample_Number'] . '-' . 'SG' . '-' . $Search['Material_Type'] . '-' . 'Fine Particles' . '.pdf', 'D');
