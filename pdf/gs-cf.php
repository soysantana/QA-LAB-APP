...
$pdf->SetXY(122, 55);
$pdf->Cell(22, 4, $Search['WtRet7'], 0, 1, 'C');
$pdf->SetXY(145, 55);
$pdf->Cell(16, 4, $Search['Ret7'], 0, 1, 'C');
$pdf->SetXY(161, 55);
$pdf->Cell(15, 4, $Search['CumRet7'], 0, 1, 'C');
$pdf->SetXY(176, 55);
$pdf->Cell(22, 4, $Search['Pass7'], 0, 1, 'C');
$pdf->SetXY(199, 55);
...
$pdf->SetXY(122, 73);
$pdf->Cell(22, 6, $Search['WtRet12'], 0, 1, 'C');
$pdf->SetXY(145, 73);
$pdf->Cell(16, 6, $Search['Ret12'], 0, 1, 'C');
$pdf->SetXY(161, 73);
$pdf->Cell(15, 6, $Search['CumRet12'], 0, 1, 'C');
$pdf->SetXY(176, 73);
$pdf->Cell(22, 6, $Search['Pass12'], 0, 1, 'C');
$pdf->SetXY(199, 73);
$pdf->Cell(19, 6, $Search['Specs12'], 0, 1, 'C');
...
$pdf->SetXY(122, 83.5);
$pdf->Cell(22, 4, $Search['WtRet14'], 0, 1, 'C');
$pdf->SetXY(145, 83.5);
$pdf->Cell(16, 4, $Search['Ret14'], 0, 1, 'C');
$pdf->SetXY(161, 83.5);
$pdf->Cell(15, 4, $Search['CumRet14'], 0, 1, 'C');
$pdf->SetXY(176, 83.5);
$pdf->Cell(22, 4, $Search['Pass14'], 0, 1, 'C');
$pdf->SetXY(199, 83.5);
$pdf->Cell(19, 4, $Search['Specs14'], 0, 1, 'C');

$pdf->SetXY(122, 87.5);
$pdf->Cell(22, 4, $Search['WtRet15'], 0, 1, 'C');
$pdf->SetXY(145, 87.5);
$pdf->Cell(16, 4, $Search['Ret15'], 0, 1, 'C');
$pdf->SetXY(161, 87.5);
$pdf->Cell(15, 4, $Search['CumRet15'], 0, 1, 'C');
$pdf->SetXY(176, 87.5);
$pdf->Cell(22, 4, $Search['Pass15'], 0, 1, 'C');
$pdf->SetXY(199, 87.5);
$pdf->Cell(19, 4, $Search['Specs15'], 0, 1, 'C');

$pdf->SetXY(122, 92);
$pdf->Cell(22, 4, $Search['WtRet16'], 0, 1, 'C');
$pdf->SetXY(145, 92);
$pdf->Cell(16, 4, $Search['Ret16'], 0, 1, 'C');
$pdf->SetXY(161, 92);
$pdf->Cell(15, 4, $Search['CumRet16'], 0, 1, 'C');
$pdf->SetXY(176, 92);
$pdf->Cell(22, 4, $Search['Pass16'], 0, 1, 'C');
$pdf->SetXY(199, 92);
$pdf->Cell(19, 4, $Search['Specs16'], 0, 1, 'C');

$pdf->SetXY(122, 96.5);
$pdf->Cell(22, 4, $Search['WtRet17'], 0, 1, 'C');
$pdf->SetXY(145, 96.5);
$pdf->Cell(16, 4, $Search['Ret17'], 0, 1, 'C');
$pdf->SetXY(161, 96.5);
$pdf->Cell(15, 4, $Search['CumRet17'], 0, 1, 'C');
$pdf->SetXY(176, 96.5);
$pdf->Cell(22, 4, $Search['Pass17'], 0, 1, 'C');
$pdf->SetXY(199, 96.5);
$pdf->Cell(19, 4, $Search['Specs17'], 0, 1, 'C');

$pdf->SetXY(122, 101);
$pdf->Cell(22, 4, $Search['WtRet18'], 0, 1, 'C');
$pdf->SetXY(145, 101);
$pdf->Cell(16, 4, $Search['Ret18'], 0, 1, 'C');
$pdf->SetXY(161, 101);
$pdf->Cell(15, 4, $Search['CumRet18'], 0, 1, 'C');
$pdf->SetXY(176, 101);
$pdf->Cell(22, 4, $Search['Pass18'], 0, 1, 'C');
$pdf->SetXY(199, 101);
$pdf->Cell(19, 4, $Search['Specs18'], 0, 1, 'C');
