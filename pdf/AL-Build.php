...
$pdf->SetXY(313, 263);
$pdf->MultiCell(86, 4, $Search['FieldComment'], 0, 'L');
...
insertarImagenBase64($pdf, $liquidlimit, 190, 110, 95, 0); // ajusta X, Y, ancho, alto

// Insertar imagen de índice de plasticidad
insertarImagenBase64($pdf, $plasticity, 190, 200, 95, 0); // ajusta X, Y, ancho, alto
