...
$pdf->setSourceFile('template/PV-F-83828_Laboratory sieve Grain size Coarse Aggregates_Rev 6 - Test Fill.pdf');
...
$values = [
    ...
    ['value' => $pass3p4,   'min' => 70,  'max' => 100,  'x' => 362, 'y' => 208],
    ['value' => $pass3p8,   'min' => 33,  'max' => 100,  'x' => 362, 'y' => 214],
    ['value' => $passn4,    'min' => 7,  'max' => 60,   'x' => 362, 'y' => 221],
    ['value' => $passn10,   'min' => 0,   'max' => 15,   'x' => 362, 'y' => 227],
...
$pdf->SetXY(54, 425);
$pdf->MultiCell(360, 4, utf8_decode($Search['Comments']), 0, 'L');

$pdf->SetXY(54, 470);
$pdf->MultiCell(360, 4, utf8_decode($Search['FieldComment']), 0, 'L');
